...
class ImageProcessor:
    ...
    def image_callback(self, rgb_data, depth_data):
        ...
        euler_angles = transformation_matrix_to_euler(transformation_matrix)
        print("Euler Angles (roll, pitch, yaw):", euler_angles)
        
        target_orientation = tf_trans.quaternion_from_euler(*euler_angles)

        print("Quaternion: ", target_orientation)
